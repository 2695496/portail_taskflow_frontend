...
import styles from './styles/UtilisateursDetailsComponent.module.css';

const UtilsateursDetailsComponent = ({ employee, onEdit, onDelete, onBack }) => (
...
export default UtilsateursDetailsComponent;
